...
# Định nghĩa Mamba_C3k2
class Mamba_C3k2(nn.Module):
    def __init__(self, c1, c2, n=1, patch_size=3, shortcut=True, g=1, e=0.5):
        super().__init__()
        self.C3k2Block = C3k2(c1, c2, n=n, shortcut=shortcut, g=g, e=e)
        self.MambaBlock = VisionMamba(
            in_dim=c1,
            out_dim=c2,
            num_mamba_blocks=n,
